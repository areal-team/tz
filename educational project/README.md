...
## Репозиторий
Создать Git репозиторий https://github.com/<ваш логин>/areal-hr-test-2025. Коммититься нужно как можно чаще, при проверке будет учитываться содержательность сообщений коммита и порции, которыми коммиты осуществляются.
